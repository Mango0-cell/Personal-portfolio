        ...
        >
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="flex items-center justify-center">
              <div className="w-full aspect-square bg-gradient-to-br from-teal-500 to-cyan-500 rounded-2xl shadow-2xl flex items-center justify-center overflow-hidden group hover:shadow-3xl smooth-transition">
                <img 
