...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const setupLenis = useCallback(() => {
    ...
    if (!useWindowScroll) {
      const scroller = scrollerRef.current;
      if (!scroller) return;
      (lenisOptions as Record<string, unknown>).wrapper = scroller;
      (lenisOptions as Record<string, unknown>).content = scroller.querySelector('.scroll-stack-inner') as HTMLElement;
    }
