...
import { Code2, Briefcase, MapPin, Bot, Zap, Globe } from "lucide-react";
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
          ...
          >
            ...
            <div className="relative z-10">
              <Briefcase className="w-10 h-10 mb-3 text-violet-400 mx-auto" />
              <div className="text-5xl font-bold bg-gradient-to-r from-blue-400 to-violet-400 bg-clip-text text-transparent mb-1">
                {t("about.stats.learning.value")}
              </div>
              <div className="text-sm text-white/50">
                {t("about.stats.learning.label")}
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <Bot className="w-8 h-8 mb-2 text-violet-400" />
              <div className="text-sm text-white/50">
